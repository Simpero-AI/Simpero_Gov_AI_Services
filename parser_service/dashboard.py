    ...
    *,
    ...
    def call():
        return client.messages.parse(
            ...
            # model" on any value, which skipped this whole tier -- no dashboard
            # structure was produced. Determinism now rests on the model default
            # plus the schema-constrained (output_format) decode.
